...
trait BaseEloquentRepository
{
    ...
    public function skipLimitOrder($skip = 0, $limit = 10, $orderBy = 'id', $direction = 'DESC'): Builder
    {
        $this->unsetClauses();
    ...
    public function skipLimit($skip = 0, $limit = 10): Builder
    {
        $this->unsetClauses();
    ...
    public function randomOrder($skip = 0, $limit = 10): Builder
    {
        $this->unsetClauses();
